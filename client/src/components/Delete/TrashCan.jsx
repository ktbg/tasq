...
export default function TrashCan(props) {
  ...
  return (
    <svg className={`${props.className}`} width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M3.15039 6H5.15039H21.1504" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M8.15039 6V4C8.15039 3.46957 8.3611 2.96086 8.73618 2.58579C9.11125 2.21071 9.61996 2 10.1504 2H14.1504C14.6808 2 15.1895 2.21071 15.5646 2.58579C15.9397 2.96086 16.1504 3.46957 16.1504 4V6M19.1504 6V20C19.1504 20.5304 18.9397 21.0391 18.5646 21.4142C18.1895 21.7893 17.6808 22 17.1504 22H7.15039C6.61996 22 6.11125 21.7893 5.73618 21.4142C5.3611 21.0391 5.15039 20.5304 5.15039 20V6H19.1504Z" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M10.1504 11V17" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M14.1504 11V17" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  )
}